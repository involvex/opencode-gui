...
describe('SseClient', () => {
	...
	describe('close behavior', () => {
		test('should stop processing after close is called', async ({
			mockFetch,
		}) => {
			const events: SseEvent[] = []
	...
	describe('retry directive', () => {
		test('should parse and honor server retry directive', async ({
			mockFetch,
		}) => {
			const events: SseEvent[] = []
	...
	describe('chunked input edge cases', () => {
		test('should handle event split across many small chunks', async ({
			mockFetch,
		}) => {
			const events: SseEvent[] = []
		...
		test('should handle chunk boundary at field separator', async ({
			mockFetch,
		}) => {
			const events: SseEvent[] = []
			mockFetch.mockResolvedValueOnce(
	...
	describe('reconnection', () => {
		test('should send Last-Event-ID header on reconnect', async ({
			mockFetch,
		}) => {
			const events: SseEvent[] = []
	...
	describe('error handling', () => {
		...
		test('should ignore id with null character per SSE spec', async ({
			mockFetch,
		}) => {
			const events: SseEvent[] = []
			mockFetch.mockResolvedValueOnce(
